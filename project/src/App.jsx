  ...
  return (
    <div className="App">
      <div className={`parent ${isGrayBackground ? "gray-background" : ""}`}>
        ...
        <div class="div2">
          <div class="div2-message">
            <TopHorizontal notifications={defaultNews} image={defaultIcon}>
              {" "}
            </TopHorizontal>
          </div>
        </div>
      ...
      <div className="device-selection">
        <h2>User Mobile Device Selection</h2>
        ...
        {device && (
          <p>{device}'s Mobile Device Authenticated. Data Synced complete.</p>
        )}
      </div>
    </div>
  );
